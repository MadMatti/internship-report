...
Finally, after the data was retrieved and velidate, they are ready to be inserted in the database.\\
...
\end{python}
The deviceID, id and displayname fileds are omitted since they are \texttt{string} and there are no differences with respectto what explained for the user \texttt{json} file.
