...
my training. The learning of this language was not very difficult, since, thanks to the course I followed, I already had a strong coding background.\\
...
The menu allows the user to choose which command to run or to open a help menu, which provide the user with information about the available commands and their usage.\\
